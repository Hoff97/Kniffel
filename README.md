...
- **Kniffel**: Der erste Kniffel gibt **50 Punkte**. Jeder weitere Kniffel gibt **zusätzlich 100 Punkte**; der Zug endet danach sofort wie gewohnt beim nächsten Spieler.
...
- **Echte Würfel** (optional, beim Start aktivierbar): Statt in der App zu würfeln, wird mit echten Würfeln gespielt. Das erzielte Ergebnis wird direkt in der gewählten Zeile eingetragen – ohne Würfelanzeige in der App. Ein zusätzlicher Kniffel (nachdem die Kniffel-Zeile schon ausgefüllt ist) wird über einen Schalter markiert und gibt +100 Punkte.
